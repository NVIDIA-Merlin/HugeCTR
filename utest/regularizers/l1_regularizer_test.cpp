...
void l1_regularizer_test(size_t batch_size, std::vector<std::pair<size_t, size_t>> layers, float lambda) {
  ...
  L1Regularizer<float> l1_regularizer(weight_buff, wgrad_buff, batch_size, lambda, cublas_handle, 0);
