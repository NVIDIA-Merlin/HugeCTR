...
```shell
$ ../build/bin/huge_ctr --train ../samples/dcn/dcn.json
```
...
Parquet output
```shell
$ ../build/bin/huge_ctr --train ../samples/dcn/dcn_parquet.json
```
Binary output (See NOTE above)
```shell
$ ../build/bin/huge_ctr --train ../samples/dcn/dcn_bin.json
```
...
2. Run huge_ctr
```shell
$ ../build/bin/huge_ctr --train ../samples/dcn/dcn_localized_embedding.json
```
