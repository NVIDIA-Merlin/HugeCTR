# DeepFM CTR SAMPLE #
A sample of building and training Deep & Cross Network with HugeCTR [(link)](https://www.ijcai.org/Proceedings/2017/0239.pdf).
...
```shell
$ cd ../../tools/criteo_script/ && bash usage.sh && cd ../../samples/deepfm/
```
