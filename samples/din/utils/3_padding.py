...
train_df = pd.DataFrame(train_set, columns = ["UID"]+["MID"+str(i) for i in range(MAX_SIZE+1)]+["CID"+str(i) for i in range(MAX_SIZE+1)]+["LABEL"])
test_df = pd.DataFrame(test_set, columns = ["UID"]+["MID"+str(i) for i in range(MAX_SIZE+1)]+["CID"+str(i) for i in range(MAX_SIZE+1)]+["LABEL"])
