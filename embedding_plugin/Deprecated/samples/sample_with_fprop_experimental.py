...
"""
This script is only used for demo of fprop_experimental
"""
...
""" 1. Define DNN model with fprop_experimental """
class PluginSparseModel(tf.keras.models.Model):
    ...
    def call(self, row_offset, values, nnz, training=True):
        ...
        # forward propagation with fprop_experimental, its inputs are CSR components. 
