...
TEST(sice_layer_old, fp32_64x128_0_48_32_64) {
...
TEST(sice_layer_old, fp32_64x128_0_32_32_64) {
  std::vector<std::pair<int, int>> ranges;
...
TEST(sice_layer_old, fp32_64x100_0_40_50_90) {
  std::vector<std::pair<int, int>> ranges;
...
TEST(sice_layer_old, fp32_64x100_0_50_40_90) {
  std::vector<std::pair<int, int>> ranges;
...
TEST(sice_layer_old, fp32_64x256_0_50_40_90_80_130) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 50));
  ranges.push_back(std::make_pair(40, 90));
...
TEST(sice_layer_old, fp32_64x256_0_32_64_80_96_128_128_160_192_256) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 32));
...
TEST(sice_layer_old, fp16_64x128_0_48_32_64) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 48));
  ranges.push_back(std::make_pair(32, 64));
...
TEST(sice_layer_old, fp16_64x128_0_32_32_64) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 32));
  ranges.push_back(std::make_pair(32, 64));
  slice_layer_test<__half>(64, 128, ranges);
...
TEST(sice_layer_old, fp16_64x100_0_40_50_90) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 40));
  ranges.push_back(std::make_pair(50, 90));
...
TEST(sice_layer_old, fp16_64x100_0_50_40_90) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 50));
  ranges.push_back(std::make_pair(40, 90));
  slice_layer_test<__half>(64, 100, ranges);
...
TEST(sice_layer_old, fp16_64x256_0_50_40_90_80_130) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 50));
  ranges.push_back(std::make_pair(40, 90));
  ranges.push_back(std::make_pair(80, 130));
...
TEST(sice_layer_old, fp16_64x256_0_32_64_80_96_128_128_160_192_256) {
  std::vector<std::pair<int, int>> ranges;
  ranges.push_back(std::make_pair(0, 32));
  ranges.push_back(std::make_pair(64, 80));
  ranges.push_back(std::make_pair(96, 128));
