...
TEST(elementwise_multiply_layer_old, fp32_40960x1x1) {
  elementwise_multiply_test<float>(40960, 1, 1, 3);
}
TEST(elementwise_multiply_layer_old, fp16_40960x1x1) {
  elementwise_multiply_test<__half>(40960, 1, 1, 3);
}
TEST(elementwise_multiply_layer_old, fp32_40960x4x3) {
  elementwise_multiply_test<float>(40960, 4, 3, 3);
}
TEST(elementwise_multiply_layer_old, fp16_40960x4x3) {
  elementwise_multiply_test<__half>(40960, 4, 3, 3);
}
TEST(elementwise_multiply_layer_old, fp32_4096x4x256) {
  elementwise_multiply_test<float>(4096, 4, 256, 3);
}
TEST(elementwise_multiply_layer_old, fp16_4096x4x256) {
