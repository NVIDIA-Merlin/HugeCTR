...
TEST(cast_layer_old, fp32_fp16_32x64) { cast_test<float, __half>(32, 64); }
TEST(cast_layer_old, fp32_fp16_64x128) { cast_test<float, __half>(64, 128); }
TEST(cast_layer_old, fp32_fp16_128x256) { cast_test<float, __half>(128, 256); }
TEST(cast_layer_old, fp32_fp16_256x512) { cast_test<float, __half>(256, 512); }
TEST(cast_layer_old, fp16_fp32_32x64) { cast_test<__half, float>(32, 64); }
TEST(cast_layer_old, fp16_fp32_64x128) { cast_test<__half, float>(64, 128); }
TEST(cast_layer_old, fp16_fp32_128x256) { cast_test<__half, float>(128, 256); }
TEST(cast_layer_old, fp16_fp32_256x512) { cast_test<__half, float>(256, 512); }
