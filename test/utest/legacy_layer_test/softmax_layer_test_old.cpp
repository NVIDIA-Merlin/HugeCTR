...
TEST(softmax_layer_old, fp32_100x100) { softmax_test<float>(100, 100); }
TEST(softmax_layer_old, fp32_100x128) { softmax_test<float>(100, 128); }
TEST(softmax_layer_old, fp32_256x384) { softmax_test<float>(256, 384); }
TEST(softmax_layer_old, fp32_512x512) { softmax_test<float>(512, 512); }
TEST(softmax_layer_old, fp32_256x1024) { softmax_test<float>(256, 1024); }
TEST(softmax_layer_old, fp32_1024x512) { softmax_test<float>(1024, 512); }
