...
TEST(scale_layer_old, fp32_100x100_0) { scale_test<float>(100, 100, 0, 3); }
TEST(scale_layer_old, fp32_512x1024_0) { scale_test<float>(512, 1024, 0, 20); }
TEST(scale_layer_old, fp32_2048x4096_0) { scale_test<float>(2048, 4096, 0, 42); }
TEST(scale_layer_old, fp32_100x100_1) { scale_test<float>(100, 100, 1, 3); }
TEST(scale_layer_old, fp32_512x1024_1) { scale_test<float>(512, 1024, 1, 17); }
TEST(scale_layer_old, fp32_2048x4096_1) { scale_test<float>(2048, 4096, 1, 42); }
