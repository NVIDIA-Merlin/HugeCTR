...
TEST(concat_layer_old, fp32_64x32_64x32) { concat_layer_test<float>(64, {32, 32}); }

TEST(concat_layer_old, fp32_5x32_5x32) { concat_layer_test<float>(5, {32, 32}); }

TEST(concat_layer_old, fp32_4096x640_4096x1280) { concat_layer_test<float>(4096, {640, 1280}); }

TEST(concat_layer_old, fp32_64x32_64x64_64x96) { concat_layer_test<float>(64, {32, 64, 96}); }

TEST(concat_layer_old, fp32_64x32_64x64_64x32_64x128) {
  concat_layer_test<float>(64, {32, 64, 32, 128});
}

TEST(concat_layer_old, fp32_64x32_64x64_64x32_64x128_64x256) {
  concat_layer_test<float>(64, {32, 64, 32, 128, 256});
}

TEST(concat_layer_old, fp16_64x32_64x32) { concat_layer_test<__half>(64, {32, 32}); }

TEST(concat_layer_old, fp16_5x32_5x32) { concat_layer_test<__half>(5, {32, 32}); }

TEST(concat_layer_old, fp16_4096x640_4096x1280) { concat_layer_test<__half>(4096, {640, 1280}); }

TEST(concat_layer_old, fp16_64x32_64x64_64x96) { concat_layer_test<__half>(64, {32, 64, 96}); }

TEST(concat_layer_old, fp16_64x32_64x64_64x32_64x128) {
  concat_layer_test<__half>(64, {32, 64, 32, 128});
}

TEST(concat_layer_old, fp16_64x32_64x64_64x32_64x128_64x256) {
