...
TEST(prelu_dice_layer_old, fp32_1x100) { prelu_dice_test<float>(1, 2); }
TEST(prelu_dice_layer_old, fp32_100x100) { prelu_dice_test<float>(100, 100); }
TEST(prelu_dice_layer_old, fp32_100x500) { prelu_dice_test<float>(20, 200); }   // 1,5; 100,500;
TEST(prelu_dice_layer_old, fp32_500x100) { prelu_dice_test<float>(500, 100); }  // 1,5; 100,500;
TEST(prelu_dice_layer_old, fp32_512x512) { prelu_dice_test<float>(512, 512); }
TEST(prelu_dice_layer_old, fp32_1048x512) { prelu_dice_test<float>(1024, 512); }
TEST(prelu_dice_layer_old, fp32_2048x512) { prelu_dice_test<float>(1024 * 2, 512); }
TEST(prelu_dice_layer_old, fp32_512x1048) { prelu_dice_test<float>(512, 1024); }
TEST(prelu_dice_layer_old, fp32_512x2048) { prelu_dice_test<float>(512, 1024 * 2); }
