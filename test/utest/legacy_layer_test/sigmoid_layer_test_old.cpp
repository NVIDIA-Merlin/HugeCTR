...
TEST(sigmoid_layer_old, fp32_10x20) { sigmoid_test<float>(10, 20); }
TEST(sigmoid_layer_old, fp32_10x500) { sigmoid_test<float>(10, 500); }
TEST(sigmoid_layer_old, fp32_512x2048) { sigmoid_test<float>(512, 1024 * 2); }
TEST(sigmoid_layer_old, fp16_10x20) { sigmoid_test<__half>(10, 20); }
TEST(sigmoid_layer_old, fp16_10x500) { sigmoid_test<__half>(10, 500); }
TEST(sigmoid_layer_old, fp16_512x2048) { sigmoid_test<__half>(512, 1024 * 2); }
