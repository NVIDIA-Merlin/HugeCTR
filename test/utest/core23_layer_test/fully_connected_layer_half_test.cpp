...
TEST(fully_connected_layer, fp16_128x1x256) { fully_connected_layer_test(128, 1, 256); }
TEST(fully_connected_layer, fp16_128x512x13) { fully_connected_layer_test(128, 512, 13); }
TEST(fully_connected_layer, fp16_128x1024x479) { fully_connected_layer_test(128, 1024, 479); }
// TEST(fully_connected_layer, fp16_128x512x1024) { fully_connected_layer_test(128, 512, 1024); }
// TEST(fully_connected_layer, fp16_128x1024x1024) { fully_connected_layer_test(128, 1024, 1024); }
TEST(fully_connected_layer, fp16_128x10x1024x1024) {
