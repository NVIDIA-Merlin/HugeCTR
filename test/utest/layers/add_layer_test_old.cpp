...
TEST(add_layer_old, fp32_40960x1x1) { add_test<float>(40960, 1, 1, 3); }
TEST(add_layer_old, fp16_40960x1x1) { add_test<__half>(40960, 1, 1, 3); }
TEST(add_layer_old, fp32_40960x4x3) { add_test<float>(40960, 4, 3, 3); }
TEST(add_layer_old, fp16_40960x4x3) { add_test<__half>(40960, 4, 3, 3); }
TEST(add_layer_old, fp32_4096x4x256) { add_test<float>(4096, 4, 256, 3); }
TEST(add_layer_old, fp16_4096x4x256) { add_test<__half>(4096, 4, 256, 3); }