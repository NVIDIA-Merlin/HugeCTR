...
TEST(concat_3d_layer_old, fp32_4x10x10) {
...
TEST(concat_3d_layer_old, fp32_4x10x13) {
  std::vector<int> items;
  std::vector<int> slot_num;
  int batch_size = 4;
...
TEST(concat_3d_layer_old, fp32_4x10x11) {
  std::vector<int> items;
  std::vector<int> slot_num;
  int batch_size = 4;
...
TEST(concat_3d_layer_old, fp32_2048x150x768) {
  std::vector<int> items;
  std::vector<int> slot_num;
  int batch_size = 2048;
...
TEST(concat_3d_layer_old, fp32_1024x300x512) {
  std::vector<int> items;
  std::vector<int> slot_num;
  int batch_size = 1024;
...
TEST(concat_3d_layer_old, fp32_4x16x8) {
  std::vector<int> items;
  std::vector<int> slot_num;
  int batch_size = 4;
...
TEST(concat_3d_layer_old, fp32_4x16x7) {
  std::vector<int> items;
  std::vector<int> slot_num;
  int batch_size = 4;
  int slot_shot_his = 3, slot_long_his = 4, slot_target = 1;
