...
TEST(reshape_layer_old, fp32_32x320to8x1280) { reshape_2d_test<float>(8 * 4, 320, 4 * 320); }

TEST(reshape_layer_old, fp32_320x32to32x320) { reshape_2d_test<float>(320, 32, 320); }

TEST(reshape_layer_old, fp32_320x32to16x1280) { reshape_2d_test<float>(320, 32, 1280); }

TEST(reshape_layer_old, fp32_320x7x13to7x13x320) { reshape_2d_test<float>(320, 7 * 13, 320); }

TEST(reshape_layer_old, fp32_32x320to16x640) { reshape_2d_test<float>(8 * 4, 320, 2 * 320); }

TEST(reshape_layer_old, fp32_8x4x320to8x1280) { reshape_3d_test<float>(8, 4, 320, 4 * 320); }

TEST(reshape_layer_old, fp32_8x4x320to4x2560) { reshape_3d_test<float>(8, 4, 320, 8 * 320); }

TEST(reshape_layer_old, fp32_8x4x320to32x2560) { reshape_3d_test<float>(8, 4, 320, 320); }
TEST(reshape_layer_old, fp32_8x100x4to8x100x4) {
  reshape_2d_to_3d_test<float>(8 * 100 * 4, 4, 100);
}

TEST(reshape_layer_old, fp16_32x320to8x1280) { reshape_2d_test<__half>(8 * 4, 320, 4 * 320); }

TEST(reshape_layer_old, fp16_32x320to16x640) { reshape_2d_test<__half>(8 * 4, 320, 2 * 320); }

TEST(reshape_layer_old, fp16_8x4x320to8x1280) { reshape_3d_test<__half>(8, 4, 320, 4 * 320); }

TEST(reshape_layer_old, fp16_8x4x320to4x2560) { reshape_3d_test<__half>(8, 4, 320, 8 * 320); }

TEST(reshape_layer_old, fp16_8x4x320to32x2560) { reshape_3d_test<__half>(8, 4, 320, 320); }