...
TEST(relu_layer_old, fp32_10x20) { relu_test<float>(10, 20); }
TEST(relu_layer_old, fp32_10x500) { relu_test<float>(10, 500); }
TEST(relu_layer_old, fp32_512x2048) { relu_test<float>(512, 1024 * 2); }

TEST(relu_layer_old, fp16_10x20) { relu_test<__half>(10, 20); }
TEST(relu_layer_old, fp16_10x500) { relu_test<__half>(10, 500); }
TEST(relu_layer_old, fp16_512x2048) { relu_test<__half>(512, 1024 * 2); }

TEST(relu_layer_old, fp16_9x19) { relu_test<__half>(9, 19); }
TEST(relu_layer_old, fp16_9x499) { relu_test<__half>(9, 499); }
TEST(relu_layer_old, fp16_511x2047) { relu_test<__half>(511, 2047); }
