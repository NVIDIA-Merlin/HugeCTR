...
TEST(test_dense_layer, reshape_layer_fp32) { dense_reshape_layer_test<float>(128, 0); }
TEST(test_dense_layer, reshape_layer_fp16) { dense_reshape_layer_test<__half>(128, 0); }