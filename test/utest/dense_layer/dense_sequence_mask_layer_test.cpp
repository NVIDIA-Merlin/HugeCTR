...
void dense_sequence_mask_layer_test() {
  ...
  Layer_t layer_type = Layer_t::SequenceMask;
...
TEST(test_dense_layer, sequence_mask_layer_fp32) { dense_sequence_mask_layer_test<float>(); }
TEST(test_dense_layer, sequence_mask_layer_fp16) { dense_sequence_mask_layer_test<__half>(); }