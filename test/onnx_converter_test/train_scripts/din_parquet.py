...
model.add(hugectr.DenseLayer(layer_type = hugectr.Layer_t.Reshape,
                            ...
                            leading_dim=360))
model.add(hugectr.DenseLayer(layer_type = hugectr.Layer_t.ElementwiseMultiply, #matmul
...
model.add(hugectr.DenseLayer(layer_type = hugectr.Layer_t.BinaryCrossEntropyLoss,
                            ...
                            top_names = ["loss"]))
model.graph_to_json("/onnx_converter/graph_files/din.json")            
model.compile()
model.summary()
model.fit(max_iter = 8100, display = 200, eval_interval = 1000, snapshot = 8000, snapshot_prefix = "/onnx_converter/hugectr_models/din")
