...
if mse > 1e-3:
  raise RuntimeError("Too large mse between WDL one hot inference and training: {}".format(mse))
  sys.exit(1)
else:
  print("WDL one hot inference results are consistent with those during training, mse: {}".format(mse))