...
REGISTER_KERNEL_BUILDER(Name("HugectrReset").Device(DEVICE_CPU), ResetOp<CPUDevice>);
REGISTER_KERNEL_BUILDER(Name("HugectrReset").Device(DEVICE_GPU), ResetOp<GPUDevice>);
