...
#ifdef USE_NVTX
    nvtxRangeId_t op_fprop = nvtxRangeStartA(std::string("Op: " + get_op_name() + " forward").c_str());
#endif
...
#ifdef USE_NVTX
    nvtxRangeId_t op_bprop = nvtxRangeStartA(std::string("Op: " + get_op_name() + " backward").c_str());
#endif
