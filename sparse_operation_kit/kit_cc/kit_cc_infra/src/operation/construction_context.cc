...
std::shared_ptr<HugeCTR::GeneralBuffer2<HugeCTR::CudaAllocator>>& DenseConstructionContext::get_buffer(
                                                                        const size_t local_replcia_id) {
...
std::shared_ptr<HugeCTR::GeneralBuffer2<HugeCTR::CudaHostAllocator>>& DenseConstructionContext::get_host_buffer(
                                                                        const size_t local_replcia_id) {
...
size_t DenseConstructionContext::get_nnz_per_slot() const {
    return nnz_per_slot_;
}
...
size_t DenseConstructionContext::get_max_feature_num() const {
    throw std::runtime_error(ErrorBase + "DenseConstructionContext does not have max_feature_num attribute.");
}

CombinerType DenseConstructionContext::get_combiner() const {
    throw std::runtime_error(ErrorBase + "DenseConstructionContext does not have combiner attribute.");
}

bool DenseConstructionContext::used_for_sparse_embedding() const {
    return false;
}
...
size_t SparseConstructionContext::get_nnz_per_slot() const {
    throw std::runtime_error(ErrorBase + "SparseConstructionContext does not have nnz_per_slot attribute.");
}

size_t SparseConstructionContext::get_max_nnz() const {
    return max_nnz_;
}

size_t SparseConstructionContext::get_max_feature_num() const {
    return max_feature_num_;
}

CombinerType SparseConstructionContext::get_combiner() const {
    return combiner_;
}

bool SparseConstructionContext::used_for_sparse_embedding() const {
    return true;
}
