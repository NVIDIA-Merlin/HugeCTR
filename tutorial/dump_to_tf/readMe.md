...
Suppose you have trained with `samples/dcn/dcn.json`, and have data (sparse_embedding0.data), model files (_dense_20000.model/0_sparse_20000.model) in your corresponding folders.
