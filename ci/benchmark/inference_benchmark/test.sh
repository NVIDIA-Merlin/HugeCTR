...
python3 /hugectr/ci/common/generate_inference_config.py --config_template /hugectr/ci/common/config_pbtxt_template.txt --ps_template /hugectr/ci/common/ps_template.json --batchsize ${BZ} --mixed_precision ${MIXED_PRECISION} --config_output /model/dlrm/config.pbtxt --ps_output /model/ps.json
