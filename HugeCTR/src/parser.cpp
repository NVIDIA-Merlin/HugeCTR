    ...
    switch (layer_type) {
      ...
      case Layer_t::Sigmoid: {
        if (use_mixed_precision) {
          ...
          output_tensor_entries.push_back({input_output_info.output_names[0], sigmoid_out_tensor.shrink()});
        } else {
          // establish out tensor
    ...
    std::vector<TensorEntry> evaluate_tensor_entries_list[resource_manager->get_local_gpu_count()];
    {
      ...
      // Create Data Reader
      {
        ...
        DataReader<TypeKey>* data_reader_tk = new DataReader<TypeKey>(
            ...
            parser.repeat_dataset_, num_workers, use_mixed_precision, false);
        ...
        DataReader<TypeKey>* data_reader_eval_tk = new DataReader<TypeKey>(
            ...
            parser.repeat_dataset_, num_workers, use_mixed_precision, cache_eval_data);
