...
void SparseEmbeddingFunctors::all2all_init_forward(std::unique_ptr<GossipComm::FasterComm> &all2all,
                                                   const std::string &plan_file,
                                                   size_t batch_size_per_gpu, size_t slot_num,
                                                   size_t embedding_vec_size,
                                                   Tensors2<Type> &send_tensors,
...
template void SparseEmbeddingFunctors::all2all_init_forward<float>(
...
template <typename Type>
void SparseEmbeddingFunctors::all2all_init_forward(
    std::unique_ptr<GossipComm::FasterComm> &all2all, const std::string &plan_file,
