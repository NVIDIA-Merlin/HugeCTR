...
void L2Regularizer::do_compute_rterm(const float* weight, float* h_rterm,
                                     int num_elements,
                                     cudaStream_t stream) {
  CK_CUBLAS_THROW_(cublasSdot(cublas_handle_,
                              num_elements,
                              weight, 1,
                              weight, 1,
                              h_rterm));
...
void L2Regularizer::do_initialize_wgrad(const float* weight, float* wgrad,
                                      int num_elements,
                                      cudaStream_t stream) {
