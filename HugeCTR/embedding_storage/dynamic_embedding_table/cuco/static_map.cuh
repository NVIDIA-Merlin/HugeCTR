 ...
 public:
  ...
  class device_mutable_view : public device_view_base {
   ...
   public:
    ...
    template <typename CG, typename Hash = cuco::detail::MurmurHash3_32<key_type>>
    __device__ std::pair<element_type *, insert_result> lookup_or_insert_unsafe(
        CG const &g, key_type const &lookup_or_insert_key, Hash hash = Hash{}) noexcept;
    ...
    template <typename CG>
    __device__ bool clear(CG const &g) noexcept;
  ...
  class device_view : public device_view_base {
   public:
    ...
    template <typename CG, typename Hash = cuco::detail::MurmurHash3_32<key_type>>
    __device__ element_type *lookup_unsafe(CG g, key_type const &lookup_key,
