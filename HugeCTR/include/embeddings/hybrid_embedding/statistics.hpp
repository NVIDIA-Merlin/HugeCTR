...
struct Statistics {
 public:
  ...
  void calculate_frequent_and_infrequent_categories(dtype *frequent_categories, dtype *infrequent_categories,
                                               dtype *category_location, const size_t num_frequent,
                                               const size_t num_infrequent, cudaStream_t stream);
