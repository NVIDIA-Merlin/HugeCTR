...
namespace HugeCTR 
{
  class IbComm
  {
    ...
    public:
      ...
      int init(size_t num_procs, size_t num_gpus, size_t my_proc,
      ...
      void set_a2a_coll_buf(HierA2ACollHandle coll, 
      ...
      void update_a2a_coll_buf(HierA2ACollHandle coll, 
          const size_t* send_sizes, const size_t* recv_sizes, 
      ...
      void set_a2a_coll_buf(HierA2AvCollHandle coll,
          void* send_ptrs, const size_t send_max_size,
          void* recv_ptrs, const size_t recv_max_size,
          size_t device_id);
      void register_a2a_coll_buf(HierA2AvCollHandle coll);
      void update_a2a_coll_sizes(HierA2AvCollHandle coll,
          const size_t* send_sizes, const size_t* recv_sizes,
          cudaStream_t dep_stream, size_t device_id);
      void pre_intra_update_a2a_coll_sizes(HierA2AvCollHandle coll,
      ...
      template <typename T>
      void set_ar_coll_buf(ARCollHandle coll, void* ar_ptr, const size_t ar_size,
          size_t device_id);
      void register_ar_coll_buf(ARCollHandle coll);
      void update_size(ARCollHandle coll, const size_t ar_size); // If size is not known during buffer registration
      template <typename T>
    ...
    private:
      ...
      template <typename T> sharp_datatype get_sharp_dtype();
