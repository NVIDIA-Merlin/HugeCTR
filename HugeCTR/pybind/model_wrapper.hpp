...
void ModelPybind(pybind11::module &m) {
  pybind11::class_<HugeCTR::DataReaderParams, std::shared_ptr<HugeCTR::DataReaderParams>>(m, "DataReaderParams")
    .def(pybind11::init<DataReaderType_t,
       ...
       pybind11::arg("source"),
       pybind11::arg("keyset") = std::vector<std::string>(),
  ...
  pybind11::class_<HugeCTR::SparseEmbedding, std::shared_ptr<HugeCTR::SparseEmbedding>>(m, "SparseEmbedding")
    .def(pybind11::init<Embedding_t,
       size_t, size_t, int, std::string, std::string, std::vector<size_t>&, std::shared_ptr<OptParamsPy>&>(),
  ...
  pybind11::class_<HugeCTR::Model, std::shared_ptr<HugeCTR::Model>>(m, "Model")
    ...
    .def("fit", &HugeCTR::Model::fit,
           ...
           pybind11::arg("max_iter") = 2000,
           pybind11::arg("display") = 200,
           pybind11::arg("eval_interval") = 1000,
           pybind11::arg("snapshot") = 10000,
           pybind11::arg("snapshot_prefix") = "")
    .def("set_source", 
           pybind11::overload_cast<std::vector<std::string>, std::vector<std::string>, std::string>(&HugeCTR::Model::set_source),
           pybind11::arg("source"),
           pybind11::arg("keyset"),
           pybind11::arg("eval_source"))
    .def("set_source", 
