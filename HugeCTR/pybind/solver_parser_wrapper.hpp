...
std::unique_ptr<SolverParser> solver_parser_helper(
    unsigned long long seed, LrPolicy_t lr_policy, int eval_interval, int eval_batches,
    int batchsize_eval, int batchsize, std::string model_file,
    std::vector<std::string> embedding_files, std::vector<std::vector<int>> vvgpu,
    bool use_mixed_precision, float scaler, std::map<metrics::Type, float> metrics_spec,
    bool i64_input_key, bool use_algorithm_search, bool use_cuda_graph) {
...
void SolverParserPybind(pybind11::module& m) {
  ...
  m.def("solver_parser_helper", &HugeCTR::python_lib::solver_parser_helper,
        ...
        pybind11::arg("eval_interval") = 1000, pybind11::arg("eval_batches") = 100,
        pybind11::arg("batchsize_eval") = 16384, pybind11::arg("batchsize") = 16384,
        ...
        pybind11::arg("use_mixed_precision") = false, pybind11::arg("scaler") = 1.f,
        pybind11::arg("metrics_spec") = metrics, pybind11::arg("i64_input_key") = false,
        pybind11::arg("use_algorithm_search") = true, pybind11::arg("use_cuda_graph") = true);
}
