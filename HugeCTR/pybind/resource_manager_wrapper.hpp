...
void ResourceManagerPybind(pybind11::module& m) {
  pybind11::class_<HugeCTR::GPUResource, std::shared_ptr<HugeCTR::GPUResource>>(m, "GPUResource")
    .def(pybind11::init<int, size_t, unsigned long long>(), 
  ...
  pybind11::class_<HugeCTR::CPUResource, std::shared_ptr<HugeCTR::CPUResource>>(m, "CPUResource")
    .def(pybind11::init<unsigned long long, size_t>(), 
		        pybind11::arg("seed"), 
			pybind11::arg("thread_num"));
  pybind11::class_<HugeCTR::ResourceManager, std::shared_ptr<HugeCTR::ResourceManager>>(m, "ResourceManager")
    .def_static("create", &HugeCTR::ResourceManager::create,
		        pybind11::arg("visible_devices"),
			pybind11::arg("seed"))
    ...
    .def("get_local_gpu", &HugeCTR::ResourceManager::get_local_gpu,
		        pybind11::arg("local_gpu_id"))
    ...
    .def("get_pid_fron_gpu_global_id", &HugeCTR::ResourceManager::get_pid_from_gpu_global_id,
		        pybind11::arg("global_gpu_id"))
    .def("get_gpu_local_id_from_global_id", &HugeCTR::ResourceManager::get_gpu_local_id_from_global_id,
		        pybind11::arg("global_gpu_id"))
    .def("p2p_enabled", &HugeCTR::ResourceManager::p2p_enabled,
		        pybind11::arg("src_dev"),
