...
void CSRChunkPybind(pybind11::module& m) {
  pybind11::class_<HugeCTR::CSRChunk<long long>>(m, "CSRChunk")
    ...
    .def("get_csr_buffer", pybind11::overload_cast<int>(&HugeCTR::CSRChunk<long long>::get_csr_buffer), 
		             pybind11::arg("i"))
    .def("get_csr_buffer", pybind11::overload_cast<int, int>(&HugeCTR::CSRChunk<long long>::get_csr_buffer),
