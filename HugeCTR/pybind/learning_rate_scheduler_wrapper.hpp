...
void LearningRateSchedulerPybind(pybind11::module& m) {
  pybind11::class_<HugeCTR::LearningRateScheduler, std::unique_ptr<HugeCTR::LearningRateScheduler>>(m, "LearningRateScheduler")
    .def(pybind11::init<float, size_t, size_t, size_t, float, float>(), 
