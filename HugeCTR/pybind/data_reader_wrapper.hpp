...
void DataReaderPybind(pybind11::module& m) {
  ...
  pybind11::class_<HugeCTR::ParquetDataReaderWorker<long long>, HugeCTR::IDataReaderWorker>(m, "ParquetDataReaderWorker64")
    .def(pybind11::init<unsigned int, unsigned int,
                        const std::shared_ptr<HeapEx<CSRChunk<long long>>>&,
                        const std::string&, size_t,
                        const std::vector<DataReaderSparseParam>&,
                        const std::vector<long long>&,
                        const std::shared_ptr<rmm::mr::device_memory_resource>&>(),
			pybind11::arg("worker_id"),
			pybind11::arg("worker_num"),
			pybind11::arg("csr_heap"),
			pybind11::arg("file_list"),
			pybind11::arg("buffer_length"),
			pybind11::arg("params"),
			pybind11::arg("slot_offset"),
			pybind11::arg("mr"))
  ...
  pybind11::class_<HugeCTR::DataReaderWorkerRaw<long long>, HugeCTR::IDataReaderWorker>(m, "DataReaderWorkerRaw64")
    .def(pybind11::init<unsigned int, unsigned int,
		        std::shared_ptr<MmapOffsetList>&,
			const std::shared_ptr<HeapEx<CSRChunk<long long>>>&,
			const std::string,
			const std::vector<DataReaderSparseParam>&,
			const std::vector<long long>&,
  ...
  pybind11::class_<HugeCTR::DataReaderWorker<long long>, HugeCTR::IDataReaderWorker>(m, "DataReaderWorker64")
    .def(pybind11::init<unsigned int, unsigned int, 
		        const std::shared_ptr<HeapEx<CSRChunk<long long>>>&,
			const std::string&, size_t, Check_t, 
			const std::vector<DataReaderSparseParam>&>(),
			pybind11::arg("worker_id"),
                        pybind11::arg("worker_num"),
                        pybind11::arg("csr_heap"),
  ...
  pybind11::class_<HugeCTR::DataReader<long long>>(m, "DataReader64")
    .def(pybind11::init<int, size_t, int,
			...
			pybind11::arg("params"),
			pybind11::arg("resource_manager"),
			pybind11::arg("num_chunk_threads")=31,
    ...
    .def("create_drwg_raw", &HugeCTR::DataReader<long long>::create_drwg_raw,
			     ...
			     pybind11::arg("slot_offset"), 
			     pybind11::arg("float_label_dense"),
			     pybind11::arg("data_shuffle")=false,
			     pybind11::arg("start_reading_from_beginning")=true)
    ...
    .def("read_a_batch_to_device_delay_release", &HugeCTR::DataReader<long long>::read_a_batch_to_device_delay_release)
    ...
    .def("get_row_offsets_tensors", pybind11::overload_cast<>(&HugeCTR::DataReader<long long>::get_row_offsets_tensors, pybind11::const_))
    .def("get_value_tensors", pybind11::overload_cast<>(&HugeCTR::DataReader<long long>::get_value_tensors, pybind11::const_))
  //.def("get_nnz_array", pybind11::overload_cast<>(&HugeCTR::DataReader<long long>::get_nnz_array, pybind11::const_))
    .def("get_row_offsets_tensors", pybind11::overload_cast<int>(&HugeCTR::DataReader<long long>::get_row_offsets_tensors, pybind11::const_),
		                      pybind11::arg("param_id"))
    .def("get_value_tensors", pybind11::overload_cast<int>(&HugeCTR::DataReader<long long>::get_value_tensors, pybind11::const_),
		                      pybind11::arg("param_id"));
  //.def("get_nnz_array", pybind11::overload_cast<int>(&HugeCTR::DataReader<long long>::get_nnz_array, pybind11::const_));
  ...
  pybind11::class_<HugeCTR::DataReader<unsigned int>>(m, "DataReader32")
    ...
    .def("read_a_batch_to_device_delay_release", &HugeCTR::DataReader<unsigned int>::read_a_batch_to_device_delay_release)
    ...
    .def("get_row_offsets_tensors", pybind11::overload_cast<>(&HugeCTR::DataReader<unsigned int>::get_row_offsets_tensors, pybind11::const_))
    .def("get_value_tensors", pybind11::overload_cast<>(&HugeCTR::DataReader<unsigned int>::get_value_tensors, pybind11::const_))
  //.def("get_nnz_array", pybind11::overload_cast<>(&HugeCTR::DataReader<long long>::get_nnz_array, pybind11::const_))
    .def("get_row_offsets_tensors", pybind11::overload_cast<int>(&HugeCTR::DataReader<unsigned int>::get_row_offsets_tensors, pybind11::const_),
		                      pybind11::arg("param_id"))
    .def("get_value_tensors", pybind11::overload_cast<int>(&HugeCTR::DataReader<unsigned int>::get_value_tensors, pybind11::const_),
		                      pybind11::arg("param_id"));
  //.def("get_nnz_array", pybind11::overload_cast<int>(&HugeCTR::DataReader<long long>::get_nnz_array, pybind11::const_));
}
