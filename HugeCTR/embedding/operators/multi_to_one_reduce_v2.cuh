...
void multi_to_one_reduce_v2(CopyDesc1 multi_to_one_desc_first_stage,
  ...
  auto partial_grad_ev_ptr = partial_reduce_result.partial_wgrad_new.get<float>();
  auto partial_ev_length_ptr = partial_reduce_result.partial_ev_length_new.get<int32_t>();
  auto partial_dst_id_array_ptr = partial_reduce_result.partial_dst_id_array_new.get<uint32_t>();
